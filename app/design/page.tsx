...
import LuxuryDesignGenerator from '@/components/design/LuxuryDesignGenerator';
...
export default function DesignPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 py-12 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-emerald-50/10 via-white to-white" />
